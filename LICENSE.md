...
> Discord rich presence editor, custom status and activity 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🎮 &nbsp;**Custom activity** — set any game or activity name

🔗 &nbsp;**Custom URL** — add a streaming URL to status

📝 &nbsp;**Rich details** — set state, details, and timestamps

🖼️ &nbsp;**Large image** — custom large and small image

⏱️ &nbsp;**Elapsed timer** — show time since activity started

🔄 &nbsp;**Presets** — save and switch between presence presets
